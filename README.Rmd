...
`lacunr` is an R package for calculating 3D lacunarity from voxel data. It is designed to be used with LiDAR point clouds to measure the heterogeneity or "gappiness" of 3-dimensional structures such as forest stands.

## Installation

You can install the development version of lacunr from [GitHub](https://github.com/) with:
